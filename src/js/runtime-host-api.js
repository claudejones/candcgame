(() => {
  ...
  const el=id=>doc()?.getElementById(id),click=id=>{const target=el(id);if(!target)return false;target.click();return true;};
  ...
  // The preserved Phase 6 gameplay controller is wired to spawnStart/spawnReset.
