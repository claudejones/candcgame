...
NA01 and NA02 landscape sets are approved. Dependent character/hazard grounding and later configuration calibration remain intentionally deferred until landscape generation is complete. NA03 is pending corrected complete-stage Git integration, deployed Design/Test/Game QA and one final user acceptance gate. It is not user-approved yet.

The first NA03 recovery deployment used image-attachment proxy copies that had been resized in transit. The later ZIP correction restored FAR and MID successfully, but its resized-and-translated GROUND derivative did not match the image the user had approved. GROUND now uses the untouched 2170x725 ZIP original that matches the user's approved attachment, SHA-256 `095aa9cb85d4d36a2cb97f9a1d72bca8255c42abda836bfedfa6eeb893293b02`, without resizing, translation or reconstruction. After deployed review exposed a small MID-to-GROUND gap at standard MID offset `Y=0`, the user supplied the intended brownstone composition again and accepted its foliage/façade detail for the correction. The transported `2048x682` copy was nearest-neighbor restored to `2172x724` and translated downward by 41 source pixels, baking in the user's tested approximately `+18` logical-pixel placement. The corrected MID SHA-256 is `97b3a625a3b0bbf887ccd0016242b4b7572e5886a8501eb5b3192da459d8bac9`; runtime MID offset remains `Y=0`. NA03 still requires deployed integrated-stage acceptance.
