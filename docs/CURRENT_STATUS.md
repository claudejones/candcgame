...
- Phase 8 covers the 27 NA/SA/EU landscape layers only. NA01, NA02, NA03 and SA01 are approved complete stage sets. North America is closed. SA02 is integrated for deployed review; it is not approved. SA03 and Europe remain pending.
...
Complete SA02 deployed integrated-stage review. Its FAR/MID/GROUND are 2172×724, with canonical zero offsets and the 621/393 source anchors. Recovery: `In claudejones/candcgame: resume SA02.` Do not begin SA03 before explicit SA02 artwork approval.
