...
- Phase 8 covers the 27 NA/SA/EU landscape layers only. NA01, NA02, NA03, SA01, SA02 and SA03 are approved complete stage sets. North America and South America are closed. SA03 was explicitly approved on 2026-09-19 and the South America regression passed; EU01 is next.
...
`In claudejones/candcgame: build landscape EU01.` SA03 is approved at reviewed revision `c1fb39c909d68b87f200c354dc2c966f96a597c1`. Its image hashes, zero offsets and anchors are unchanged. All nine South America PNGs and canonical composites pass; host/renderer startup, saved-config migration and reset checks pass. Live Amazon/Andes/Rio composition and Inspector geometry are verified. See `docs/phase8-qa/SA03_LANDSCAPE_QA.md` for closeout evidence. Europe production has not started.
