...
NA01 and NA02 landscape sets are approved. Dependent character/hazard grounding and later configuration calibration remain intentionally deferred until landscape generation is complete. The newly generated NA03 MID standalone candidate is user-approved and is being integrated at standard runtime `Y=0`; NA03 still requires deployed Design/Test/Game QA and one final complete-stage user acceptance gate. The NA03 stage is not approved yet.

The first NA03 recovery deployment used image-attachment proxy copies that had been resized in transit. The later ZIP correction restored FAR and MID successfully, but its resized-and-translated GROUND derivative did not match the image the user had approved. GROUND now uses the untouched 2170x725 ZIP original that matches the user's approved attachment, SHA-256 `095aa9cb85d4d36a2cb97f9a1d72bca8255c42abda836bfedfa6eeb893293b02`, without resizing, translation or reconstruction. Repeated deployed review established that the prior supplied MID composition could not simultaneously preserve the desired restrained foliage/sidewalk relationship and use standard runtime `Y=0`. A fresh 2172x724 RGBA MID was therefore generated against the locked Phase 8 contract. After rejecting an overgrown intermediate, the user approved the standalone candidate with reduced low shrub clusters and readable brownstone bases, SHA-256 `adc6a17a5a40b01ceead9b52219c48f4cfe35d90291a7398a8f1d9d96b0deb8a`. Runtime MID offset remains `Y=0`; NA03 still requires deployed integrated-stage acceptance.
