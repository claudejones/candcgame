...
NA01 and NA02 landscape sets are approved. Dependent character/hazard grounding and later configuration calibration remain intentionally deferred until landscape generation is complete. The alternate NA03 MID direction is user-approved and is being integrated at standard runtime `Y=0`; NA03 still requires deployed Design/Test/Game QA and one final complete-stage user acceptance gate. The NA03 stage is not approved yet.

The first NA03 recovery deployment used image-attachment proxy copies that had been resized in transit. The later ZIP correction restored FAR and MID successfully, but its resized-and-translated GROUND derivative did not match the image the user had approved. GROUND now uses the untouched 2170x725 ZIP original that matches the user's approved attachment, SHA-256 `095aa9cb85d4d36a2cb97f9a1d72bca8255c42abda836bfedfa6eeb893293b02`, without resizing, translation or reconstruction. Deployed review proved that the preceding MID still required runtime `Y=16`. The replacement uses the user-approved alternate storefront/brownstone direction and deterministic lower overscan so authored frontage continues through the final source row at standard runtime `Y=0`. Its SHA-256 is `9a6e14456bc351c18229c503d0827f5bbbf83f521a6f24bce25a2c7a7cf5ef14`. NA03 still requires deployed integrated-stage acceptance.
